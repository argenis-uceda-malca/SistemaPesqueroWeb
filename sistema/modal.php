...
if (!empty($_POST)) {
  ...
  if ($_POST['action'] == 'searchCliente') {
    ...
    if ($result > 0) {
      ...
      $url = "https://apirest.sbperu.com/v2/consultar-dni/".$dni."?token=cVaFW4vL9XycVRaxuEEcHYM8VcDNSpe4aQvPwYMwMevHsqppKT6dN7s4sTMvQg9ufa8FaZsWsvvgMjhq933H4mhJYvbAUsgaHZ7w";
